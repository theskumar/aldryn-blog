...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedUnicodeItem'
        db.create_table(u'aldryn_blog_taggedunicodeitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_blog_taggedunicodeitem_tagged_items', to=orm['contenttypes.ContentType'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'aldryn_blog_taggedunicodeitem_tagged_unicode_items', to=orm['taggit.Tag'])),
        ))
        db.send_create_signal(u'aldryn_blog', ['TaggedUnicodeItem'])


    def backwards(self, orm):
        # Deleting model 'TaggedUnicodeItem'
        db.delete_table(u'aldryn_blog_taggedunicodeitem')
    ...
    models = {
        ...
        u'aldryn_blog.taggedunicodeitem': {
            'Meta': {'object_name': 'TaggedUnicodeItem'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'aldryn_blog_taggedunicodeitem_tagged_items'", 'to': u"orm['contenttypes.ContentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'aldryn_blog_taggedunicodeitem_tagged_unicode_items'", 'to': u"orm['taggit.Tag']"})
        },
        u'auth.group': {
